            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        ...
                        <h4 style="font-family: 'Montserrat', sans-serif;" class="mt-4">Please Register</h4>
                    </div>
                </div>
                ...
                <div class="row justify-content-center mt-2">
                    <div class="col-3">
                        <asp:TextBox ID="txtMail" runat="server" class="form-control" placeholder="E-Mail"></asp:TextBox>
